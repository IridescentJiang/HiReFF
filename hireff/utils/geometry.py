...
from hireff.utils.distortion import apply_distortion, iterative_undistortion, single_undistortion
...
def unproject_depth_map_to_point_map(
    ...
    # Convert world_points_array to tensor
    world_points_array = torch.tensor(world_points_array, dtype=torch.float32, device=device)
