...
class SMCReader:
    ...
    def get_mask(self, Camera_id, Frame_id=None, disable_tqdm=False, return_bytes=False):
    ...
    def get_img(self, Camera_group, Camera_id, Image_type,Frame_id=None,disable_tqdm=False, return_bytes=False):
